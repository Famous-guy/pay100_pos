...
class InitialOnboarding4 extends StatefulWidget {
  const InitialOnboarding4({super.key});

  @override
  State<InitialOnboarding4> createState() => _InitialOnboarding4State();
}

class _InitialOnboarding4State extends State<InitialOnboarding4> {
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Center(child: Image.asset('assets/images/1004.png')),
