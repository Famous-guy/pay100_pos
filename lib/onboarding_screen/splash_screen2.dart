...
class InitialOnboarding1 extends StatefulWidget {
  const InitialOnboarding1({super.key});

  @override
  State<InitialOnboarding1> createState() => _InitialOnboarding1State();
}

class _InitialOnboarding1State extends State<InitialOnboarding1> {
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Center(child: Image.asset('assets/images/1002.png')),
            ...
            Expanded(
              child: Column(
                children: [
                  Text(
                    'Next Level  Payments Experience',
                    style: TextStyle(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => InitialOnboarding2(),
                                  ));
                            },
                            style: ElevatedButton.styleFrom(
                                shape: RoundedRectangleBorder(
